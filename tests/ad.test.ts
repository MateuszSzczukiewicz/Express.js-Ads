...
test("AdRecord.findAll null returns array of found entries", async () => {
...
test("AdRecord.findAll returns empty array searching for something that does not exist.", async () => {
  const ads = await AdRecord.findAll("--------------------------------------");
